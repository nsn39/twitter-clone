...
function Navbar () {
    ...
    return (
        <div className="basis-3/12 py-4 pl-12">
            <div>
                <a className="h-12 w-12 hover:bg-gray-200 rounded-full" href="/">
            ...
            <button className="text-xl font-bold text-white bg-sky-400 mt-4 py-2 px-4 rounded-full ">Post</button>

            <div className="relative" id="profile-bar">
                <div className="flex flex-row items-center mt-4 hover:bg-gray-300 rounded-full p-2 cursor-pointer">
                    <img src="/lex.jpeg" className="flex-none h-10 w-10 rounded-full mr-4"/>

                    <div className="grow flex flex-col">
                        <p className="font-bold text-base">{userData.fullname}</p>
                        <p className="text-sm text-gray-400">@{userData.username}</p>
                    </div>

                    <button onAuxClick={toggleDropdown} onClick={toggleDropdown}  className="flex-none h-8 w-8 mr-3 flex items-center justify-center rounded-full hover:bg-sky-400">
