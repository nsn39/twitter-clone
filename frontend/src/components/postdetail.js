...
function PostDetail(props) {
    ...
    useEffect(() => {
        ...
        .then((data) => {
            ...
            document.title = "@" + data.username + " : " + data.content.slice(0, 35);
        });
        ...
        fetch(REACT_APP_BACKEND_URL + "has_retweeted/" + props.tweetSlug, {
            method: "GET",
            credentials: "include"
        })
        .then((res) => {
    ...
    return (
        <div className="h-screen md:w-[46%] border-x-[0.5px] border-gray-100 flex flex-col">
            ...
            <div className="flex flex-col px-4 mt-2">
                <p className="mb-2 leading-tight text-xl">{tweetData.tweetText}</p>
                <QuoteTweetComponent />
                <p className="text-slate-400 mt-1 pb-2">{dateInfo.beautifiedTimeAgoPost}</p>

                <div className='flex flex-row p-2 items-center justify-stretch border-y-[0.1px] border-gray-100'>
                    <div className='flex flex-row w-full items-center text-slate-600 hover:text-blue-400'>
                        ...
                        {
                            (tweetAnalytics.replies_count > 0) 
                            && 
                            <p className='ml-1 text-sm'>{tweetAnalytics.replies_count}</p>
                        }
                    </div>
                    ...
                    <div className='flex flex-row w-full items-center text-slate-600 hover:text-red-400'>
...

                        {
                            ...
                            && 
                            <p className={'ml-1 text-sm ' + likeCountColor}>{tweetAnalytics.likes_count}</p>
                        }
                    </div>
            ...
            <div className='flex flex-row p-4 border-b-[0.1px] border-gray-100'>
