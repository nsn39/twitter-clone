...
function SignupModal({isVisible, onClose}) {
    ...
    return (
        <div onClick={handleClose} id="wrapper" className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
            <div className="basis-1/2 flex flex-col bg-white rounded-lg h-[80vh] overflow-y-scroll">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col px-24 py-12">
                    <h3 className="font-bold text-3xl mb-2">Create your account.</h3>

                    <input onChange={handleChange} className="pl-2 pr-10 py-4 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300" type="text" placeholder="Full name" name="fullname" value={formData.fullname} />

                    <input onChange={handleChange} className="pl-2 pr-10 py-4 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300" type="text" placeholder="E-mail address" name="email" value={formData.email}/>

                    <input onChange={handleChange} className="pl-2 pr-10 py-4 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300" type="text" placeholder="Phone no." name="phoneNo" value={formData.phoneNo} />
                    ...
                    <div className="flex flex-row">
                        <div className="relative">
                            <select onChange={handleChange} className="flex-none pl-2 pr-10 pt-7 pb-2 mr-4 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300 bg-white" name="birthDay" value={formData.birthDay}>
                        ...
                        <div className="relative">
                            <select onChange={handleChange} className="grow pl-2 pr-10 pt-7 pb-2 rounded-lg mb-4 mr-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300 bg-white" name="birthMonth" value={formData.birthMonth}>
                        ...
                        <div className="relative">
                            <select onChange={handleChange} className="flex-none pl-2 pr-10 pt-7 pb-2 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300 bg-white" name="birthYear" value={formData.birthYear}>
                    ...
                    <select onChange={handleChange} className="pl-2 pr-10 py-4 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300 bg-white" name="gender" value={formData.gender}>
                    ...
                    <input onChange={handleChange} className="pl-2 pr-10 py-4 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300" type="text" placeholder="Preferred username" name="username" value={formData.username} />
                    ...
                    <input onChange={handleChange} className="pl-2 pr-10 py-4 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300" type="password" placeholder="Enter Password." name="password" value={formData.password} />
                    <input onChange={handleChange} className="pl-2 pr-10 py-4 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300" type="password" placeholder="Re-enter Pasword." name="confirmPassword" value={formData.confirmPassword} />

                    <label className="font-bold mb-1">Select the country you're from</label>
                    <select onChange={handleChange} className="pl-2 pr-10 py-4 rounded-lg mb-4 border border-gray-300 focus:outline focus:outline-[2px] focus:outline-sky-300 bg-white" name="country" value={formData.country}>
                    ...
                    <button type="submit" className="bg-sky-400 text-white font-bold px-10 py-4 border-[0.5px] border-gray-300 rounded-full mx-4">Join Twitter</button>
                </form>
